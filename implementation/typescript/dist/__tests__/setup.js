...
expect.extend({
    toContainValidKotlinClass(received) {
    ...
    toHaveValidPackageDeclaration(received) {
    ...
    toContainRequiredImports(received) {
        const importLines = received.split('\n').filter(line => line.startsWith('import'));
        const hasValidImports = importLines.every(line => /^import\s+[\w.]+(\.\*)?$/.test(line.trim()));
